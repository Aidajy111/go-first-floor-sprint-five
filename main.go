...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedInMS, 2)/heightInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours())
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return float64(s.LengthPool*s.CountPool) / s.Duration.Hours()
}
